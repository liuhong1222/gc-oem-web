<template>
  <div class="mod-user">
    ...
    <el-table :data="dataList" v-loading="dataListLoading" @filter-change="filterChange" :header-cell-class-name="tableheaderClassName"
      ...
      <el-table-column prop="customerName" header-align="center" align="center" fixed width="180" label="公司名称">
      </el-table-column>
      ...
      <el-table-column prop="preMoney" align="center" header-align="center" label="充值金额" width="100" sortable>
      </el-table-column>
      <el-table-column prop="discountMoney" width="100" header-align="center" align="center" sortable label="优惠金额">
      </el-table-column>
      <el-table-column prop="actualMoney" header-align="center" align="center" width="100" sortable label="实付金额">
      </el-table-column>
      <el-table-column prop="orderNo" header-align="center" align="center" width="160" label="订单流水号">
      </el-table-column>
      <el-table-column prop="payMode" header-align="center" align="center" width="100" :formatter="formDataPayMode" label="支付方式">
      </el-table-column>
      <el-table-column prop="auditStatus" header-align="center" align="center" width="80" :formatter="formAuditStatus" label="支付状态">
      </el-table-column>
      <el-table-column prop="createTime" width="140" header-align="center" align="center" sortable label="订单时间">
      </el-table-column>
      <el-table-column prop="payedDate" width="140" header-align="center" align="center" sortable label="到账时间 ">
      </el-table-column>
      <el-table-column prop="dutyManName" width="100" header-align="center" align="center" label="负责人">
      </el-table-column>
      <el-table-column prop="auditUserName" width="100" header-align="center" align="center" label="审核人">
      </el-table-column>
      <el-table-column prop="auditMark" width="140" header-align="center" align="center" label="审核备注">
      </el-table-column>
      <el-table-column fixed="right" header-align="center" align="center" min-width="160" label="操作">
