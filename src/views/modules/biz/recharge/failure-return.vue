<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        <el-input style="width:230px" v-model="inputDisabledValue" :placeholder="allListMessage" @change="inputDisabledValueFn"
          clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="dataList" v-loading="dataListLoading" @filter-change="filterChange" :header-cell-class-name="tableheaderClassName"
      ...
      <el-table-column prop="reMoney" header-align="center" align="center" width="100" sortable label="返还金额">
      </el-table-column>
      <el-table-column prop="auditStatus" header-align="center" align="center" width="100" :formatter="formAuditStatus"
        label="审核状态">
      </el-table-column>
      <el-table-column prop="auditUserName" header-align="center" align="center" width="100" label="创建人">
      </el-table-column>
      <el-table-column prop="createTime" header-align="center" align="center" width="140" sortable label="申请时间">
      </el-table-column>
      <el-table-column prop="auditDate" header-align="center" align="center" width="140" sortable label="审核时间">
      </el-table-column>
      <el-table-column prop="dataStatus" header-align="center" align="center" :formatter="formDataStatus" width="100"
        label="客户状态">
      </el-table-column>
      <el-table-column prop="mark" header-align="center" align="center" width="150" label="申请备注">
      </el-table-column>
    ...
    <el-pagination @size-change="sizeChangeHandle" @current-change="currentChangeHandle" :current-page="dataForm.page"
      :page-sizes="[10, 20, 50, 100]" :page-size="dataForm.size" :total="totalPage" layout="total, sizes, prev, pager, next, jumper">
    </el-pagination>
