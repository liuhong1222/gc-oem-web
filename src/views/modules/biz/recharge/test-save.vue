      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div v-if="scope.row.auditStatus  === 1">
            <el-button @click="testSaveRecall(scope.row)">撤回</el-button>
          </div>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("biz/bizfreeorder/list"),
        method: "get",
    ...
    testSaveRecall(e) {
      ...
      this.$nextTick(() => {
        this.$refs.accountEmergency.init(e, "testSave");
      });
    },
    // 新增 / 修改
