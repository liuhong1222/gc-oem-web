  ...
  <div class="mod-user">
    <div v-if="this.screening === true">
      ...
      <div style="display: inline-block;" v-model="joinStatus">
        ...
        <ul style="    list-style: none;float:left;background:#e68f8f; padding:8px; margin-right:20px;border-radius:4px;color:#fff;">
          <li style="float:left;margin-left:5px;" v-for="item in joinStatusList"
          key="joinStatusList"> {{item}}</li>
        </ul>
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="客户状态"
        width="150"
        :filters=" [{text: '意向', value: 1}, {text: '合作', value:2}, {text: '丢弃' ,value:3}, {text: '到期' ,value: 4}, {text:'潜在',value:5}, {text:'注销' ,value:6}]"
