<template>
  <div class="mod-user">
    ...
    <el-table :data="dataList" v-loading="dataListLoading" @filter-change="filterChange" :header-cell-class-name="tableheaderClassName"
      ...
      <el-table-column prop="companyName" width="180" fixed header-align="center" align="center" label="归属公司">
      </el-table-column>
      <el-table-column prop="accountUsername" header-align="center" align="center" width="160" label="手机号">
      </el-table-column>
      <el-table-column prop="balance" header-align="center" align="center" width="100" label="余额">
      </el-table-column>
      <el-table-column prop="userName" header-align="center" align="center" width="100" label="负责人">
      </el-table-column>
      <el-table-column prop="pinName" header-align="center" align="center" width="100" label="销售负责人">
      </el-table-column>
      <el-table-column prop="serviceName" header-align="center" align="center" width="100" label="	运维负责人">
      </el-table-column>
      <el-table-column prop="createDate" header-align="center" align="center" width="200" sortable ref="createDate" label="创建时间">
      </el-table-column>
      <!-- <el-table-column
         prop="balanceYuan"
         header-align="center"
