<template>
  <div class="mod-user">
    ...
    <el-table :data="dataList" v-loading="dataListLoading" @filter-change="filterChange" :header-cell-class-name="tableheaderClassName"
      ...
      <el-table-column prop="balance" header-align="center" align="center" width="100" label="应还金额">
      </el-table-column>
      <el-table-column prop="disposeMoney" header-align="center" align="center" width="100" sortable label="还款金额">
      </el-table-column>
      <el-table-column prop="auditStatus" header-align="center" align="center" width="100" :formatter="formAuditStatus" label="审核状态">
      </el-table-column>
      <el-table-column prop="createTime" header-align="center" align="center" width="140" sortable label="下单时间">
      </el-table-column>
      <el-table-column prop="createUserName" header-align="center" align="center" width="100" label="创建人">
      </el-table-column>
      <el-table-column prop="mark" header-align="center" align="center" label="备注">
      </el-table-column>
