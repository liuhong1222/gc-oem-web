<template>
  <div class="mod-user">
    ...
    <el-table :data="dataList" v-loading="dataListLoading" @filter-change="filterChange" :header-cell-class-name="tableheaderClassName"
      ...
      <el-table-column prop="orderNo" width="180" fixed header-align="center" align="center" label="退款订单号">
      </el-table-column>
      ...
      <el-table-column prop="balance" header-align="center" align="center" width="100" label="账户余额">
      </el-table-column>
      <el-table-column prop="auditStatus" header-align="center" align="center" width="100" :formatter="formAuditStatus" label="审核状态">
      </el-table-column>
      <el-table-column prop="createUserName" header-align="center" align="center" width="100" label="	创建人">
      </el-table-column>
      <el-table-column prop="createTime" header-align="center" align="center" width="200" sortable label="申请时间">
      </el-table-column>
      <el-table-column prop="auditDate" header-align="center" align="center" width="200" sortable label="审核时间">
      </el-table-column>
      <el-table-column prop="dataStatus" header-align="center" align="center" width="100" :formatter="formDataStatus" label="客户状态">
      </el-table-column>
      <el-table-column prop="mark" header-align="center" align="center" width="100" label="申请备注">
      </el-table-column>
