<template>
    <div class="main">
        ...
        <div class="userTable">
            <el-table :data="oemTableData" style="width: 100%" :header-cell-style="getRowClass" >
                ...
                <el-table-column fixed="right" label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" size="small" @click="addUpdateLevel(1)">修改</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        <!-- 删除代理商等级 -->
        <el-dialog title="删除代理商等级" :visible.sync="deletedialogVisible" width="30%">
            <span>是否删除一级代理商以及相关信息？</span>
            <span slot="footer" class="dialog-footer">
          <el-button @click="deletedialogVisible = false">取 消</el-button>
          <el-button type="primary" @click="deletedialogVisible = false">确 定</el-button>
        </span>
        </el-dialog>
        <add-grade-update v-if="gradeVisible" ref="gradeCon"></add-grade-update>
    </div>
</template>
